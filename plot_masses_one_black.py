...
#STY['label']['fontsize'] = 'xx-large'
cm = 0.393701
cm *= 3/1.75
print STY['figure_rect_big']['figsize']
STY['figure_save']['dpi'] = 150
STY['figure_rect_big']['figsize'] = (15*cm, 10*cm)
print STY['figure_rect_big']['figsize']
...
ax.plot(most, rng_log, color='#FF6200', linestyle='-', linewidth=4.0)

# black line
ax.plot(rng,rng, color='k', linestyle='-', linewidth=4.0)
...
ax.set_xlabel('Stellar Mass $M_\mathrm{stel}$ [ $M_{\odot}$ ]', **STY['label'])
#ax.set_ylabel('Total Mass $M_\mathrm{tot}$ [ $M_{\odot}$ ]', **STY['label'])
ax.set_ylabel('Lensing Mass $M_\mathrm{lens}$ [ $M_{\odot}$ ]', **STY['label'])
